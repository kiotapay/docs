---
title: "Sub Organisation Allocations"
description: "This is all allocations that are done to the organisation itself "
---

## Endpoint

GET /api/sandbox/v1/allocations/sub/org/all
