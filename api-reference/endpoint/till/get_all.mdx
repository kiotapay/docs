...
openapi: 'GET /api/sandbox/v1/till/all'
---
...
<InteractiveApi
  method="GET"
  url="https://api.kiotapay.co/api/sandbox/v1/till/all"
  queryParameters={[
  {
    name: "companyId",
    type: "string",
...
```bash
curl --location 'https://api.kiotapay.co/api/sandbox/v1/till/all?companyId=4d6e1ea9-5ab8-496a-978f-7e9b2bce80c4'
```
