...
description: Fetches all send money transactions for a specific `companyId`.
...
```bash
curl --location 'https://api.kiotapay.co/api/sandbox/v1/send-money/all?companyId=4d6e1ea9-5ab8-496a-978f-7e9b2bce80c4'
```
    ...
    "data": [
        {
            "id": 2,
            "amount": 1000.0,
            "uuid": "70494779-cb4c-4138-8ba8-28be0a6fb987",
            "organisation": {
                "id": 2,
