...
```bash
curl --location 'https://api.kiotapay.co/api/sandbox/v1/send-money/status?companyId=4d6e1ea9-5ab8-496a-978f-7e9b2bce80c4&requestId=cd3e5b37-8f23-465e-a720-b2a78f2b62c1'
```
