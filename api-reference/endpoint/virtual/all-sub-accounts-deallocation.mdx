---
title: "Sub-Accounts DeAllocations"
description: "This provides all de-allocations done by a given logged-in account."
---

## Endpoint

GET /api/sandbox/v1/de-allocations/org/all
