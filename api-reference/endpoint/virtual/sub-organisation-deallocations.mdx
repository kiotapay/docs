---
title: "Sub Organisation Deallocation Api"
description: "This is all de-allocations that are done to the organisation itself "
---

## Endpoint

GET /api/sandbox/v1/de-allocations/sub/org/all
