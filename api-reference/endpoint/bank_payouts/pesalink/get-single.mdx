---
title: "Get Single Bank (Pesalink) Payment API"
description: "Description of your new file."
---

# Get Single Bank (Pesalink) Payment API
...
`GET `/api/sandbox/v1/bank/pesalink/single
...
```bash
curl --location 'https://api.kiotapay.co/api/sandbox/v1/bank/pesalink/single?
