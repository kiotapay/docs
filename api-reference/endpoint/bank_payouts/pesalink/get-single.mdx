...
This API retrieves the details of all Bank payment for an org by id
...
```bash
curl --location 'https://api.kiotapay.co/api/sandbox/v1/bank/pesalink/single?requestId=98b66546-0a83-4209-b037-adf5fb78d5ca' \
