---
title: "Get all Bank Payments (Pesalink)"
description: "Description of your new file."
---

# Get All Bank (Pesalink) Payments API
...
`GET `/api/sandbox/v1/bank/pesalink/alll
...
```bash
curl --location 'https://api.kiotapay.co/api/sandbox/v1/bank/pesalink/all' \
