---
title: "Make a Bank Payment (Pesalink)"
description: "Description of your new file."
---

# Bank Payment API

This API allows a company to create a new bank payment transaction using Pesalink.

---

## **Endpoint**

`POST /api/sandbox/v1/bank/pesalink/new`
...
```json
{
    ...
    "receiverPhoneNumber": "254728702080",
...
| receiverPhoneNumber | String | The **phone number** associated with the beneficiary (recipient) account number. |
