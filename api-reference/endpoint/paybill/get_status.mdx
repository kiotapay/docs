...
```bash
curl --location --request GET 'https://api.kiotapay.co/api/sandbox/v1/paybill/status?companyId=4d6e1ea9-5ab8-496a-978f-7e9b2bce80c4&requestId=4f88dd2e-c4b4-4a3f-9605-1679686a6641' \
