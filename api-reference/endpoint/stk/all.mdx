...
openapi: 'GET /api/sandbox/v1/stk/all'
---
...
```bash
curl --location 'https://api.kiotapay.co/api/sandbox/v1/stk/all?companyId=4d6e1ea9-5ab8-496a-978f-7e9b2bce80c4' \
