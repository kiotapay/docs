...
openapi: 'GET /api/sandbox/v1/stk/single'
---
...
```bash
curl --location 'https://api.kiotapay.co/api/sandbox/v1/stk/single?companyId=4d6e1ea9-5ab8-496a-978f-7e9b2bce80c4&requestId=43d23a1d-0476-4d49-a6eb-0a402c50d968' \
